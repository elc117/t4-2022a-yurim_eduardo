...
public class GamePhysics {
    ...
    public Body boxCreate (World world, int x, int y, float w, float h, boolean isDynamic) {
    ...
    public void rectangleCreate (World world, Rectangle rect, boolean isDynamic) {
